...
root = Tk()
root.withdraw()
root.dirname = filedialog.askdirectory(initialdir="./", title="Open Data files")
Folderpath = root.dirname
...
# Folderpath = os.getcwd() + '\\mark_to_neuro_imgtxt'
os.chdir(Folderpath)
...
for file in folder_files:
    ...
    while True:
        with open(Txtfile, 'r', encoding='UTF8') as FT:
            ...
            JsonFilePath = 'C:\\Users\\KDH\\PycharmProjects\\Neuro_Trans\\test.json'
            #JsonFilePath = root.filename
